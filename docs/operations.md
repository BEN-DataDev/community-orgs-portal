...
<script lang="ts">
    ...
    onMount(async () => {
        ...
        map = new maplibregl.Map({
            ...
            style: 'https://api.maptiler.com/maps/basic/style.json?key=' + import.meta.env.VITE_MAPTILER_KEY,
...
<div 
    ...
    class="w-full h-[400px] rounded-lg overflow-hidden shadow-md"
>
...
<script lang="ts">
    ...
    let operationalHours = $state(Object.fromEntries(
...
>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
            <label class="block mb-2">Staff Count</label>
            <input 
                type="number" 
                name="staff_count" 
                min="0"
        ...
        <div>
            <label class="block mb-2">Volunteer Count</label>
            <input 
                type="number" 
    ...
    <div>
        <h3 class="font-medium mb-2">Locations</h3>
        ...
        {/each}
        <Button type="button" on:click={addLocation}>
            Add Location
        </Button>
    </div>

    <div>
        <h3 class="font-medium mb-2">Operating Hours</h3>
    ...
    <div>
        <h3 class="font-medium mb-2">Service Areas</h3>
