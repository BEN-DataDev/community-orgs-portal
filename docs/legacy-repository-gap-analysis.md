...
1. **Complete the pre-publication boundary:** the private
   [registry-seed candidate contract](registry-seed-contract.md) is now implemented
   locally. Complete directory search (U01) and the correction workflows in U04
   before publishing a substantially larger cohort.
