...
| U04 — Medium           | P32 adds scoped edit actions and controls for existing aliases, document links, locations and relationships, including end dates.                                                                                                                                                                                                                                     | **Implemented and deployed.** Relationship partners remain persisted as names, so linked identity is still a separate model decision. A signed-in editor browser regression remains useful follow-up coverage.                                                                                   |
