        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Card title="Financial Status">
                <div class="space-y-2">
                    ...
                    <p><strong>Last Audit:</strong> {new Date(financialInfo.last_audit_date).toLocaleDateString()}</p>
                </div>
            </Card>
        </div>
    {/if}
...
>
    ...
    <div>
        <h3 class="font-medium mb-2">Funding Sources</h3>
        ...
        {/each}
        <Button type="button" on:click={addFundingSource}>
            Add Funding Source
        </Button>
    </div>
