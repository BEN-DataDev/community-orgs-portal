...
| P15 | Generate field-level changes — complete locally | [Private dry-run reports](field-level-changes.md): six record categories, field evidence, prior observations/revisions and guarded missing-record comparisons; full local SQL/route validation passed, deployment pending |
