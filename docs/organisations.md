...
<div class="container mx-auto px-4 py-8">
	<div class="mb-6 flex items-center justify-between">
		...
		<Button on:click={() => (showCreateForm = true)}>Add Organisation</Button>
	</div>
...
<div class="container mx-auto px-4 py-8">
	<div class="mb-6 flex items-center justify-between">
		...
		<div class="flex gap-4">
			<Button href="/organisations/{organisation.org_id}/roles" variant="secondary">
				Manage Roles
			</Button>
	...
	<div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
		<div class="lg:col-span-2">
			<OrganisationDetails {organisation} {isEditing} />
		</div>
...
<nav class="flex justify-center space-x-2">
	{#each visiblePages as page}
		...
		<a
			...
			class="rounded-md px-3 py-2 {page === currentPage
			...
			<Card title="Basic Information">
				<div class="space-y-4">
					<div>
						...
						<input type="text" name="legal_name" bind:value={formData.legal_name} class="input" />
					</div>
					<div>
